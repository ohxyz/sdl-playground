...
main( int argc, char* args[] ) {
    ...
    while ( !shouldQuit ) {
        ...
        auto frame = new Frame( 10, 10, 100, 200 );

        frame->setBackgroundColor( 128, 0, 0, 255 );
        frame->setHitboxCircle( 20, 20, 30 );
        frame->setHitboxColor( 0, 0, 128, 255 );
        frame->renderBackground();
        frame->renderHitboxCircle();
