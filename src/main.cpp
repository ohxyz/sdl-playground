...
main( int argc, char* args[] ) {
    ...
    auto bg = new Object2D( 0, 0, 360, 462, "images/bg.png" );
    auto desert = new Object2D( 0, 460, 360, 180, "images/desert.png" );
    auto ranger = new Object2D( 10, 10, 188, 222, "images/ranger.bmp", { 0, 0, 48, 64} );
